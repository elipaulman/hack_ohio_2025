        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <nav className="hidden md:flex space-x-4 text-gray-600">
              ...
              <a className="hover:text-gray-900" href="#">Listings</a>
              <a className="hover:text-gray-900" href="#">About</a>
            </nav>
          </div>
          <div className="flex items-center">
            <img className="rounded-full w-8 h-8 border border-gray-300" src="https://media-exp1.licdn.com/dms/image/C5603AQGEQ6ydraNeww/profile-displayphoto-shrink_200_200/0/1623517758261?e=1629331200&v=beta&t=mhUiw4p21E9okkvInvM0ry8lmLsT6s5ppWMKo6kFs2M" alt="avatar" />
          </div>
        </div>
      </header>
